...
SELECT
COUNT(_) AS total_rows,
COUNT(_) FILTER (WHERE date IS NULL) AS null_dates,
COUNT(_) FILTER (WHERE ticker IS NULL) AS null_tickers,
COUNT(_) FILTER (WHERE open_price IS NULL) AS null_open,
